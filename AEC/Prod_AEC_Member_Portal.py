...
login_payload = {
    "username": "aec",
    "password": "UXpWMVFqUTNOV1ZUTmpBNQ=="
}
...
def test_fetch_emp_data_with_token(bearer_token):
    ...
    headers = {
        ...
        "X-Tenant-Id":"SVBfQUVDO1NhdCBGZWIgMTcgMjAyNCAyMzo1Njo1OSBHTVQrMDUzMCAoSW5kaWEgU3RhbmRhcmQgVGltZSk="
    }
...
def test_getmember(test_fetch_emp_data_with_token):
    get_url = f"https://testfabric.carynhealth.com/api/v42/enrollment/getViewDetails/{test_fetch_emp_data_with_token}"
    print(get_url)
