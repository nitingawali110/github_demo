...
base_url = "https://dev.fabric.carynhealth.com/api/v1/"
...
def test_getmember(test_fetch_emp_data_with_token):
    get_url = f"https://dev.fabric.carynhealth.com/api/v31/enrollment/getViewDetails/{test_fetch_emp_data_with_token}"
    print(get_url)
