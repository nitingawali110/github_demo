...
def test_fetch_emp_data_with_token(bearer_token):
    ...
    headers = {
        ...
        "X-Tenant-Id": "TkVUV0VMTDtTdW4gRmViIDE4IDIwMjQgMDA6MTQ6MzcgR01UKzA1MzAgKEluZGlhIFN0YW5kYXJkIFRpbWUp"
    }
...
def test_getmember(test_fetch_emp_data_with_token):
    get_url = f"https://testfabric.carynhealth.com/api/v14/enrollment/getViewDetails/{test_fetch_emp_data_with_token}"
    print(get_url)
